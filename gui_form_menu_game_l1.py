...
class FormGameLevel1(Form):
    def __init__(
        ...
        self.enemy_list: list = Enemy.set_enemies("l1")
        self.plataform_list = Plataform.set_platforms("l1")
        self.items_list = Item.set_items("l1")
        self.bullet_list = []
    ...
    def update(self, lista_eventos, keys, delta_ms):
        ...
        for item in self.items_list:
            ...
            if not self.items_list:  # condiciones para ganar
